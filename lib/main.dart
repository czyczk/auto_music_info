...
import 'package:auto_music_info/core/providers/ami_service/impl/dummy_info_extractor_service_impl.dart';
...
import 'package:auto_music_info/core/providers/ami_service/impl/info_extractor_service_impl.dart';
    ...
    return FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<AppConfig> snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            InfoExtractorService infoExtractorService = useDummyData
                ? DummyInfoExtractorServiceImpl()
                : InfoExtractorServiceImpl(appConfig: appConfig);
            ...
            return MultiProvider(providers: [
              ...
              ChangeNotifierProvider(create: (_) => infoExtractorService),
